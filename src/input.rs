...
pub(crate) const REGISTRY: &[Binding] = &[
    ...
    Binding {
        intent: Intent::PageUp,
        name: "page_up",
        default_keys: &[KeyCode::PageUp],
        description: "Move up one screenful (content pane, or the tree cursor).",
        category: "Navigation",
    },
    Binding {
        intent: Intent::PageDown,
        name: "page_down",
        default_keys: &[KeyCode::PageDown, KeyCode::Char(' ')],
        description: "Move down one screenful (content pane, or the tree cursor).",
        category: "Navigation",
    },
    Binding {
    ...
    Binding {
        intent: Intent::NextChanged,
        name: "next_changed",
        default_keys: &[KeyCode::Char(']')],
        description: "Jump to the next changed file (wraps at the end).",
        category: "Search & jump",
    },
    Binding {
        intent: Intent::PrevChanged,
        name: "prev_changed",
        default_keys: &[KeyCode::Char('[')],
        description: "Jump to the previous changed file (wraps at the start).",
        category: "Search & jump",
    },
    Binding {
...
mod tests {
    ...
    const BINDINGS: &[(KeyCode, Intent)] = &[
        ...
        (KeyCode::Char(']'), Intent::NextChanged),
        (KeyCode::Char('['), Intent::PrevChanged),
